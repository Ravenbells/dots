...
myKeys =
    -- Xmonad
        [ ("M-S-x", spawn "xmonad --recompile && xmonad --restart")  -- Recompiles xmonad
    ...
    -- Run Prompt
        ...
        --, ("M-S-<Return>", spawn "dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn 'NotoMonoRegular:bold:pixelsize=14'")
